...
datamanager = torchreid.data.ImageDataManager(
        root='reid-data',
        sources="market1501",
        targets=["cuhk03", "msmt17", "dukemtmcreid"],
        height=256,
        width=128,
...
model_student, model_grl_student, optimizer_student, scheduler_student, start_epoch = initialize_model_optimizer_scheduler(
        ...
        path_model="log/source_training/market1501/resnet18/source_market1501.pth.tar-40"
        )
...
for i in range(0, len(datamanager.targets)):
        model, model_grl, optimizer, scheduler, start_epoch = initialize_model_optimizer_scheduler(
                ...
                optim='adam', lr=0.0003,
                lr_scheduler='single_step', stepsize=50,
                path_model="log/source_training/market1501/resnet34/source_market1501.pth.tar-40"
        )
...
engine.run(
        save_dir='log/market_to_all3/student_18_teacher_34',
        max_epoch=300,
        eval_freq=1,
        print_freq=10,
        test_only=False,
