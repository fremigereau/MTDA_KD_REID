...
def main():
    ...
    log_dir = 'log/final_tests/KD_ReID_LKD_target_{stda}/{sources}2{targets}[cuhk_split}/{teacher}_t_{student}_s/{multi_head}{target_alt}{kd_style}{target_order}{lkd_s_w}{lda_w}'.format(
                stda=args.stda,
